...
function execBuild() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        ccReportTask = yield execEnableCodeCoverage();
...
function applySonarQubeArgs(mvnsq, execFileJacoco) {
...
*/
function readCodeCoverageReportAsDom(fileName) {
    const htmlString = fs.readFileSync(path.join(reportDirectory, fileName), 'utf-8');
 ...
 * @param fileName - name of html file with extension
*/
function writeDomAsHtml(dom, fileName) {
...
function replaceImageSourceToBase64() {
    ...
    try {
        ...
        images.forEach(element => {
            const pathToImg = path.join(reportDirectory, element.src);
