...
const addPropToJson_1 = require("./addPropToJson");
...
function mavenSettingsJsonInsertServer(json, serverJson) {
    ...
    (0, addPropToJson_1.addPropToJson)(json.settings.servers, 'server', serverJson);
}
...
function insertRepoJsonIntoPomJson(pomJson, repoJson) {
    ...
    (0, addPropToJson_1.addPropToJson)(pomJson.project.repositories, 'repository', repoJson);
}
