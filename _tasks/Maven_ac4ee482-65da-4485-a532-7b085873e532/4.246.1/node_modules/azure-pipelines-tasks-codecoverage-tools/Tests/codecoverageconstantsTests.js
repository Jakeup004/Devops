...
exports.codecoverageconstantsTests = void 0;
const assert = require("assert");
const rewire = require("rewire");
const sinon = require("sinon");
const util = require("../utilities");
const stubs = require("./data/stubs");
const fakeData = require("./data/fakeData");
const expectedResults = require("./data/expectedResults");
...
function codecoverageconstantsTests() {
    ...
    describe('functions related to build script configuration', () => {
        ...
        it('function jacocoMavenMultiModuleReport should return correct configuration', () => {
            const actual = codecoverageconstantsRewire.jacocoMavenMultiModuleReport(fakeData.reportArtifactId, fakeData.sourceDirs, fakeData.classDirs, fakeData.includeFilterStringified, fakeData.excludeFilterStringified, fakeData.groupId, fakeData.formattedParentData, fakeData.modules);
            assert.strictEqual(actual, expectedResults.jacocoMavenMultiProject);
        });
        it('function coberturaMavenEnable should call \'util.convertXmlStringToJson\' once with correct parameters', () => __awaiter(this, void 0, void 0, function* () {
...
exports.codecoverageconstantsTests = codecoverageconstantsTests;
